...
public class LevelChunkSection {
   ...
   /**
    * P-02: shared empty-states container. Block.BLOCK_STATE_REGISTRY is a JVM-wide
    * static, so a single instance is safe across all worlds.
    *
    * INVARIANT: this container must never be mutated. All entry points that could
    * mutate (setBlockState non-air, read, getStates) call {@link #promoteStates()}
    * first.
    */
   private static final PalettedContainer<BlockState> EMPTY_BLOCK_STATES =
   ...
   public LevelChunkSection(Registry<Biome> p_282873_) {
      ...
      this.states = EMPTY_BLOCK_STATES;
   ...
   private void promoteStates() {
      if (this.states == EMPTY_BLOCK_STATES) {
